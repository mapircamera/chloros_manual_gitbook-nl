---
description: In het laboratorium gemeten panelen die worden gebruikt om vastgelegde gegevens in de nabewerking te kalibreren
metaLinks:
  alternates:
...
De T4 diffuse referentiedoelen hebben de volgende reflectiecurves, [gegevens hier downloaden](https://cdn.shopify.com/s/files/1/0972/5566/files/MAPIR_Diffuse_Reflectance_Standard_Calibration_Target_Data_T4.xlsx?v=1741759157):
...
Als u de gekalibreerde beelden in Chloros uitvoert als de gebruikelijke JPG of TIFF, wordt het reflectiepercentage berekend door de pixelwaarde te delen door de bitdiepte van het beeldformaat. Voor JPG deelt u dus door 255 en voor TIFF deelt u door 65.535. U kunt ook kiezen voor de PERCENT-formaatuitvoer in Chloros, waarbij elke pixel een percentage tussen 0,0 en 1,0 heeft (0% tot 100% reflectie). Houd er wel rekening mee dat sommige afbeeldingstoepassingen geen afbeeldingen met percentages (drijvende komma) accepteren en dat ze veel opslagruimte innemen.

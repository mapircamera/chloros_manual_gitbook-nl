...
Via het <img src=".gitbook/assets/icon_user.JPG" alt="" data-size="line"> kantbalkmenu kunt u inloggen op uw Chloros+ account en extra functies ontgrendelen.
...
{% hint style=&quot;info&quot; %}
**SDK-gebruikers**: De Python SDK biedt ook een programmatische `logout()`-methode om opgeslagen inloggegevens te wissen. Zie de [Python SDK documentatie](api-python-sdk.md#logout) voor meer informatie.
{% endhint %}
...
<table><thead><tr><th width="168.5999755859375" align="right">Chloros+-abonnement</th><th align="center">COPPER</th><th align="center">BRONZE</th><th align="center">ZILVER</th><th align="center">GOUD</th></tr></thead><tbody><tr><td align="right">Ondersteunde apparaten</td><td align="center">2</td><td align="center">2</td><td align="center">5</td><td align="center">10</td></tr></tbody></table>

...
* Geëxtraheerd uit EXIF-metadata van de afbeelding
...
* Versnelt de doel detectie tijdens verwerking aanzienlijk
...
* **Camera-model filter**: groepeer afbeeldingen op cameratype als u meerdere camera&#x27;s gebruikt.***
